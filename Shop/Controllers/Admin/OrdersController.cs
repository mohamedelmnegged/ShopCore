...
namespace Shop.Controllers.Admin
{
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View("../Admin/Orders/Index",await applicationDbContext.ToListAsync());
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,ProductId,Status,Amount,Purchase")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            return View("../Admin/Orders/Delete",order);
        }
